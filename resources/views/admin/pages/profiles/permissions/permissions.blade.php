    ...
    <div>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a class="active" href="javascript:void(0)">Permissões do perfil {{ $profile->name }}</a>
            </li>
        </ol>
        <h1 class="d-inline-flex mr-3" style="vertical-align: middle">Permissões do perfil {{ $profile->name }}</h1>
                    ...
                    @foreach($permissions as $permission)
                        <tr>
                            ...
                            <td style="width: 20%">
                                ...
                                <a href="{{ route('profiles.permissions.detach', [$profile->id, $permission->id]) }}" class="btn btn-outline-secondary">
