    ...
    <div>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a class="active" href="javascript:void(0)">Funções</a>
            </li>
        </ol>
        <h1 class="d-inline-flex mr-3" style="vertical-align: middle">Funções</h1>
                    ...
                    @foreach($roles as $role)
                        <tr>
                            ...
                            <td style="width: 25%">
                                ...
                                <a href="{{ route('roles.permissions.index', $role->id) }}" class="btn btn-outline-secondary">
                                    <span class="fas fa-lock-open mr-2"></span>
                                </a>
                                <a href="{{ route('roles.users.index', $role->id) }}" class="btn btn-outline-secondary">
                                    <span class="fas fa-lock-open mr-2"></span>
                                </a>
                            </td>
                        </tr>
