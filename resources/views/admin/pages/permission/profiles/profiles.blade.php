    ...
    <div>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a class="active" href="{{ route('permissions.index') }}">Permissões</a>
            </li>
            <li class="breadcrumb-item">
                <a class="" href="{{ route('permissions.show', $permission->id) }}">Permissão {{ $permission->name }}</a>
            </li>
            <li class="breadcrumb-item active">
                <a class="active" href="javascript:void(0)">Perfis da permissão {{ $permission->name }}</a>
            </li>
        </ol>
        <h1 class="d-inline-flex mr-3" style="vertical-align: middle">Perfis da permissão {{ $permission->name }}</h1>
